...
def lists():
    ...
    return render_template('board/list.html', title='날씨 경보', list=True, work='board', profile=g.user, boards=boards)
...
def view(id):
    ...
    return render_template('board/view.html', title='날씨 경보', profile=g.user, board=board)
...
def add():
    ...
    return render_template('board/add.html', title='날씨 경보', profile=g.user)
...
def edit(id):
    ...
    return render_template('board/edit.html', title='날씨 경보', profile=g.user, board=board)
