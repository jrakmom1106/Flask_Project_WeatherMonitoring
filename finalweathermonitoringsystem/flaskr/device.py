...
def lists():
    ...
    return render_template('device/list.html', title='지역별 날씨정보', list=True, work='device', profile=g.user, devices=devices)
...
def view(id):
    ...
    return render_template('device/view.html', title='지역별 날씨정보', profile=g.user, device=device)
...
def add():
    ...
    return render_template('device/add.html', title='지역별 날씨정보', profile=g.user)
...
def edit(id):
    ...
    return render_template('device/edit.html', title='지역별 날씨정보', profile=g.user, device=device)
